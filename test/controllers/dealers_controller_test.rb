...
class DealersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealer" do
    assert_difference("Dealer.count") do
      post dealers_url, params: { dealer: { location: @dealer.location, name: @dealer.name } }
    end
  ...
  test "should update dealer" do
    patch dealer_url(@dealer), params: { dealer: { location: @dealer.location, name: @dealer.name } }
